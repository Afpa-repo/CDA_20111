...
final class Version20210127103615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, pr_id INT DEFAULT NULL, civilite VARCHAR(4) NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, adresse1 VARCHAR(200) DEFAULT NULL, adresse2 VARCHAR(200) DEFAULT NULL, cp VARCHAR(5) DEFAULT NULL, ville VARCHAR(150) NOT NULL, tel VARCHAR(10) DEFAULT NULL, email VARCHAR(255) NOT NULL, bloque TINYINT(1) DEFAULT 0, pseudo VARCHAR(20) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, mdp VARCHAR(255) NOT NULL, niveau TINYINT DEFAULT NULL, inscription timestamp DEFAULT CURRENT_TIMESTAMP, desinscription DATE DEFAULT NULL, descr TEXT DEFAULT NULL, INDEX pr_id (pr_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
