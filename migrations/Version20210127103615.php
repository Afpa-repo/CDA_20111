...
final class Version20210127103615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE PointRetrait (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(150) NOT NULL, adresse VARCHAR(255) NOT NULL, cp VARCHAR(5) NOT NULL, ville VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(5) DEFAULT NULL, ouverture VARCHAR(5) NOT NULL, fermeture VARCHAR(5) NOT NULL, jour VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
